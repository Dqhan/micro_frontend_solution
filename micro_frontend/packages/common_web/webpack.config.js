...
var baseConfigs = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [{ from: path.resolve(__dirname, 'theme'), to: path.resolve(__dirname, 'build/theme/') }],
    }),
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        'application_react_a': 'application_react_a@http://localhost:9528/remoteEntry.js',
